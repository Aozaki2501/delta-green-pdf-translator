...
HISTORY_SUFFIX_LABELS = (
    ...
    ("_risk_workbench.md", "风险页工作台"),
    ("_rule_symbols.md", "规则符号"),
    ("_timeline.md", "时间线"),
    ("_timeline.json", "时间线 JSON"),
    ("_word_review.md", "Word 校对包"),
    ("_word_review.docx", "Word 校对包"),
    ("_prep_checklist.md", "备团清单"),
    ("_module_structure.md", "模组结构"),
    ("_module_structure.json", "模组结构 JSON"),
    ("_run_report.md", "效果报告"),
    ("_manifest.json", "运行清单"),
    ("_audit.json", "审计记录"),
    (".progress.json", "进度"),
...
INTERNAL_OUTPUT_SUFFIXES = (
    ...
    "_word_review.docx",
    "_prep_checklist.md",
    "_module_structure.md",
    "_module_structure.json",
    "_run_report.md",
    "_manifest.json",
    "_audit.json",
    ".progress.json",
